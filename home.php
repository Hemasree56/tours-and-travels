...
<div style="background:url(images/home-slide-1.jpg) no-repeat;width:100%;height:700px">
	<center>
		<p style="color:white;font-size:30px;padding-top:300px;">explore, discover, travel</p>
               <h4 style="color:white;font-size:60px">travel arround the world</h4>
...
<section class="home-offer">
   <div class="content">
      <h3>upto 50% off</h3>
      <p>Use code HEMASREE to get 50% up to Rs 100 instant discount on routes with source cities Delhi, Hyderabad,RK Valley, Kadapa , Gandi!</p>
      <a href="book.php" class="btn">book now</a>
   </div>
</section>
